            ...
            <LoaderComponent>
              <article className="flex flex-col items-start justify-center gap-[30px]">
                ...
                <p className=" font-medium text-[#100F0F] leading-[26px]">
                  ...
                  პორტლანდცემენტი ყველაზე ფართოდ გამოყენებადი ცემენტის ტიპია და
                  ის გამოიყენება ბეტონის, აგურების, ფილების დასამზადებლად. მისი
                  მთავარი მახასიათებელი არის სწრაფი გამყარება და მაღალი
                  სიმტკიცე. პორტლანდცემენტის შემადგენლობაში შედის კირქვა, თიხა
                  და გიფსის მცირე რაოდენობა. მისი მაღალი სიმტკიცე მას იდეალურს
                  ხდის ხანგრძლივი კონსტრუქციებისთვის, როგორიცაა ხიდები,
                  სარდაფები და საყრდენი კედლები.
                </p>
                ...
                <p className=" font-medium text-[#100F0F] leading-[26px]">
                  ...
                  მიზნებისთვის, რათა შენობების ფერი და ტექსტურა იყოს ესთეტიკური
                  და უნიკალური. ის ასევე კარგი ვარიანტია მოპირკეთებული ან
                  გამჭვირვალე ზედაპირებისთვის
                </p>
                ...
                <p className=" font-medium text-[#100F0F] leading-[26px]">
                  ...
                  მთავარი უპირატესობაა სწრაფი სიმტკიცე და გამძლეობა, რაც
                  ამცირებს მშენებლობის პროცესს და საშუალებას აძლევს მშენებელს,
                  სწრაფად მიაღწიოს სასურველ შედეგს.
                </p>

                <p className=" font-medium text-[#100F0F] leading-[26px]">
                  <span className="font-bold">4. ჰიდრავლიკური ცემენტი: </span>ეს
                  ცემენტი გამოირჩევა წყალში მდგრადობით და იდეალურია წყალთან
                  მყოფი კონსტრუქციებისთვის, როგორიცაა წყალსაცავები, ხიდები და
                  სარდაფები. ის ინარჩუნებს თავის სტრუქტურულ თვისებებს ტენიან
                  გარემოშიც, რაც მას უნიკალურ გამოყენებად აქცევს.
                </p>
              </article>
              <Image
              ...
              <article className="flex flex-col  gap-[30px]">
                ...
                <p className=" font-medium text-[#100F0F] leading-[26px]">
                  ...
                  შერჩევა – პორტლანდცემენტი იდეალურია ბეტონისთვის, თეთრი ცემენტი
                  – ესთეტიკური პროექტებისთვის, ხოლო ჰიდრავლიკური ცემენტი –
                  წყალთან დაკავშირებული პროექტებისთვის. ყურადღება მიაქციეთ
                  ცემენტის ხარისხს, წარმოების თარიღს და მის სწორად შენახვის
                  პირობებს.
                </p>
              </article>
            </LoaderComponent>
