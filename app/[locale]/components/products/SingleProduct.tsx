...
function SingleProduct({ image, title, description, flexDir }: TArgs) {
  ...
  return (
    ...
    >
      <div className="flex-1 pt-6 md:pt-0 pb-8 md:pb-0 text-center flex flex-col gap-8 md:justify-center md:px-8">
        <h1 className="text-3xl md:text-4xl font-bold text-white">
          {t(title)}
        </h1>
        <p className="text-base md:text-2xl color-[#A3A3A3]">
          {t(description)}
        </p>
      </div>
